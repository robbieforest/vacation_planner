class LikesController < ApplicationController
  def index
    ...
    @likes = @q.result(:distinct => true).includes(:user, :detail).page(params[:page]).per(10)
  ...
  def create_row
    ...
    @like.detail_id = params.fetch("detail_id")
  ...
  def create_row_from_trip_detail
    @like = Like.new
    ...
    if @like.valid?
      ...
      redirect_to("/trip_details/#{@like.detail_id}", notice: "Like created successfully.")
    else
      render("like_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def destroy_row_from_detail
    ...
    redirect_to("/trip_details/#{@like.detail_id}", notice: "Like deleted successfully.")
  end
